%&preformat-synopsis
\RequirePackage[l2tabu,orthodox]{nag} % Раскомментировав, можно в логе получать рекомендации относительно правильного
%использования пакетов и предупреждения об устаревших и нерекомендуемых пакетах
...
\begin{center}
    ...
    Издательство ДВФУ \\ 690091, Владивосток, ул.\ Пушкинская, 10.
\end{center}
\cleardoublepage
