...
\begin{figure}[h!t]
    \begin{minipage}[b][][b]{0.49\linewidth}
        \centering
        \includegraphics[width=1\linewidth]{boundary/theta_bw} \\ а) $\theta$
    \end{minipage}
    \hfill
    \begin{minipage}[b][][b]{0.49\linewidth}
        \centering
        \includegraphics[width=1\linewidth]{boundary/phi_bw} \\ б) $\varphi$
    \end{minipage}
...
В рамках численного моделирования квазилинейной начально-краевой задачи~\eqref{eq:3_2:1}--\eqref{eq:3_2:3}
...
%
%% authorvak
    \nocite{mesenev_23_opt}%
    \nocite{mesenev_23_problem}%
    %
    %% authorwos
    \nocite{mesenev_23_inv_proc}%
    %
    %% authorscopus
    \nocite{mesenev_23_math}%
    %
    %% authorpathent
    \nocite{mesenev_22_penalty}%
    %
    %% authorprogram
    \nocite{Mesenev_22_analysis}%
    %
    %% authorconf
    \nocite{mesenev_21_optimal_proc}%
    \nocite{mesenev_20_opt_proc}%
    %
    %% authorother
    \nocite{mesenev_20_alg}%
    \nocite{mesenev_18_boundary}%
    \nocite{progbib1}%
    \nocite{progbib2}%
    \nocite{progbib3}%
    \nocite{mesenev_18_boundary_proc}%
    \insertbiblioauthorgrouped

    \ifnumgreater{\value{usefootcite}}{0}{
        \begin{refcontext}[labelprefix={}]
            \ifnum \value{bibgrouped}>0
               % Вывод всех работ автора, сгруппированных по источникам
            \else
