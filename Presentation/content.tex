...
\note{
    \begin{itemize}
        ...
        \item Теоретич.\ обоснование устойчивости решений в рассматриваемых моделях -- октрытая проблема.
        ...
        \item Полученные результаты экспериментов позволяют высказатать гипотезу об устойчивости решений рассматриваемых моделей,
        которую в дальнейшем предполагается обосновать теоретически.
    \end{itemize}
