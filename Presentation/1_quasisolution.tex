...
\note{
    ...
    Стеклянный параллелепипед, у которого боковые стороны "обычные",
    верхняя грань - участок наблюдения,
...
\note{
    \begin{itemize}
        \item Выведенные условия оптимальности, а также предложенный алгоритм представлен на слайде.
    \end{itemize}
