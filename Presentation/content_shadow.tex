...
\end{frame}
\note{
    22. Теорема условий оптимальности представляет необходимые условия оптимальности 1 порядка
    и используется в главе 4.
...
\end{frame}
\note{
    Напомним как выглядела исходная стационарная модель
    сложного теплообмена 34 слайда назад.
