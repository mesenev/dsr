...
%%% Структура диссертации (ГОСТ Р 7.0.11-2011, 4)
    ...
    \include{Dissertation/part1_1}
    \include{Dissertation/part1_2}
    \include{Dissertation/part1_3}
    \include{Dissertation/part1_4}
    \include{Dissertation/part1_5}
