%%% Основные сведения %%%
\newcommand{\thesisAuthorLastName}{Месенев}
...
{заместитель директора по науке, г.~Новосибирск}
...
{зав. кафедрой математического анализа и моделирования, г.~Благовещенск}
...
{20 февраля 2026~г.~в~14:00}
\newcommand{\defenseCouncilNumber}     % Защита, номер диссертационного совета
{Д24.1.027.01}
\newcommand{\defenseCouncilTitle}      % Защита, учреждение диссертационного совета
{Институте автоматики и процессов управления ДВО РАН}
...
{«\underline{\hspace{0.5cm}}» \underline{\hspace{3cm}} 2025 года}
