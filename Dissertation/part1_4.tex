...
неотрицательные константы$\theta_{0}, \gamma$, определенные на $\Gamma$,  и функция $\beta$,
...
\begin{theorem}
    ...
    \end{align}
\end{theorem}
%Доказательство теоремы~\ref{th:1_4:weakExist} основано на построении
%операторного уравнения, которое определяет слабое решение
%задачи~\eqref{eq:1_4:4-1}--\eqref{eq:1_4:4-4},
