...
\begin{figure}[h]
    \label{fig:2_3:1}
    \includegraphics[width=\textwidth]{paper03/1}
...
\begin{figure}[h]
    \label{fig:2_3:2}
    \includegraphics[width=\textwidth]{paper03/2}
    \caption{}
\end{figure}
...
\begin{figure}[h!]
    \label{fig:4_3:123}
    \centering
    { \includegraphics[width=\textwidth]{6_cheb/1} }
    \caption{}
\end{figure}
...
\begin{center}
    \includegraphics[width=\textwidth]{6_cheb/3}
\end{center}
...
\begin{center}
    \includegraphics[width=\textwidth]{6_cheb/4}
\end{center}
