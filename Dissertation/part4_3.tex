...
\begin{figure}[ht]
    \label{fig:2_3:1}
    \centerfloat{ \includegraphics[scale=0.5]{paper03/1} }
...
\begin{figure}[ht]
    \label{fig:2_3:2}
    \centerfloat{\includegraphics[scale=0.5]{paper03/2}}
    \caption{}
\end{figure}
...
\begin{figure}[ht]
    \centerfloat{\includegraphics[scale=0.5]{6_cheb/1}}
...
\begin{center}
    \includegraphics[width=\textwidth]{6_cheb/2}
\end{center}

\begin{figure}[ht]
    \label{fig:4_3:4}
    \centerfloat{\includegraphics[scale=0.5]{6_cheb/2}}
    \caption{}
\end{figure}
...
\begin{figure}[ht]
    \label{fig:4_3:5}
    \centerfloat{\includegraphics[scale=0.5]{6_cheb/3}}
    \caption{}
\end{figure}
...
\begin{figure}[ht]
    \label{fig:4_3:6}
    \centerfloat{\includegraphics[scale=0.5]{6_cheb/4}}
    \caption{}
\end{figure}
...
\includegraphics[width=\textwidth]{2_cheb/1}

Рисунок 1: Область.

\includegraphics[width=\textwidth]{2_cheb/2}
